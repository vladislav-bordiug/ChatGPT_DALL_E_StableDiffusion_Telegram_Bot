...
class DataBase:
    ...
    async def is_user(user_id: int, pool):
    ...
    async def insert_user(user_id: int, username: str, pool):
        async with pool.connection() as conn:
            async with conn.cursor() as cursor:
    ...
    async def get_chatgpt(user_id: int, pool):
        async with pool.connection() as conn:
            async with conn.cursor() as cursor:
    ...
    async def set_chatgpt(user_id: int, result: int, pool):
        async with pool.connection() as conn:
            async with conn.cursor() as cursor:
                await cursor.execute(f"UPDATE users SET chatgpt = {result} WHERE user_id = '{user_id}'")
                await conn.commit()

    async def get_dalle(user_id: int, pool):
        async with pool.connection() as conn:
            async with conn.cursor() as cursor:
    ...
    async def set_dalle(user_id: int, result: int, pool):
        async with pool.connection() as conn:
            async with conn.cursor() as cursor:
                await cursor.execute(f"UPDATE users SET dall_e = {result} WHERE user_id = '{user_id}'")
                await conn.commit()

    async def get_stable(user_id: int, pool):
        async with pool.connection() as conn:
            async with conn.cursor() as cursor:
    ...
    async def set_stable(user_id: int, result: int, pool):
        async with pool.connection() as conn:
            async with conn.cursor() as cursor:
                await cursor.execute(f"UPDATE users SET stable_diffusion = {result} WHERE user_id = '{user_id}'")
                await conn.commit()

    async def get_userinfo(user_id: int, pool):
        async with pool.connection() as conn:
            async with conn.cursor() as cursor:
    ...
    async def new_order(invoice_id: int, user_id: int, product: str, pool):
        async with pool.connection() as conn:
            async with conn.cursor() as cursor:
                await cursor.execute("INSERT INTO orders(invoice_id, user_id, product) VALUES (%s, %s, %s)", (invoice_id, user_id, product))
                await conn.commit()

    async def get_orderdata(invoice_id: int, pool):
        async with pool.connection() as conn:
            async with conn.cursor() as cursor:
    ...
    async def update_chatgpt(user_id: int, invoice_id: int, pool):
        async with pool.connection() as conn:
            async with conn.cursor() as cursor:
    ...
    async def update_dalle(user_id: int, invoice_id: int, pool):
        async with pool.connection() as conn:
            async with conn.cursor() as cursor:
    ...
    async def update_stable(user_id: int, invoice_id: int, pool):
        async with pool.connection() as conn:
            async with conn.cursor() as cursor:
